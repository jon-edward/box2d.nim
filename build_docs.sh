...
nim doc --project -d:boot --d:nimPreviewSlimSystem --outdir:"./docs/htmldocs" ./src/box2d.nim
nim md2html --project -d:boot --d:nimPreviewSlimSystem --outdir:"./docs/htmldocs" ./docs/index.md