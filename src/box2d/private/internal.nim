...
proc b2CreateBitSet*(bitCapacity: uint32): b2BitSet {.cdecl, importc: "b2CreateBitSet".}

proc b2DestroyBitSet*(bitSet: ptr b2BitSet): void {.cdecl, importc: "b2DestroyBitSet".}

proc b2SetBitCountAndClear*(bitSet: ptr b2BitSet; bitCount: uint32): void {.cdecl, importc: "b2SetBitCountAndClear".}

proc b2InPlaceUnion*(setA: ptr b2BitSet; setB: ptr b2BitSet): void {.cdecl, importc: "b2InPlaceUnion".}

proc b2GrowBitSet*(bitSet: ptr b2BitSet; blockCount: uint32): void {.cdecl, importc: "b2GrowBitSet".}
...
proc b2AddKey*(set: ptr b2HashSet; key: uint64): bool {.cdecl, importc: "b2AddKey".}

proc b2RemoveKey*(set: ptr b2HashSet; key: uint64): bool {.cdecl, importc: "b2RemoveKey".}

proc b2ContainsKey*(set: ptr b2HashSet; key: uint64): bool {.cdecl, importc: "b2ContainsKey".}

proc b2GetHashSetBytes*(set: ptr b2HashSet): cint {.cdecl, importc: "b2GetHashSetBytes".}
